...
export default function Booking() {
  ...
  const destinationsList = useMemo(
    () => rd.map(d => ({
      value: String(d.id),
      label: d.name,
      countryId: d.countryId ? String(d.countryId) : undefined,
  ...
  if (form.submitted) {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-emerald-50 via-white to-green-50
                      flex items-center justify-center p-4 overflow-y-auto">
        <div className="w-full max-w-2xl xl:max-w-3xl my-auto">
          <SuccessScreen
  ...
  /* ══════════════════════════════════════════════
     MAIN FORM — FULLSCREEN CENTERED
  ══════════════════════════════════════════════ */
  return (
    <div className="fixed inset-0 overflow-hidden bg-gradient-to-br
      ...
      <div className="relative z-10 h-full overflow-y-auto">
        <div className="min-h-full flex flex-col items-center justify-center
                        px-4 py-6 sm:py-8 lg:py-12">

          {/* ── WhatsApp mini banner ── */}
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            className="w-full max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mb-3 lg:mb-4"
          >
            <div className="flex items-center justify-between bg-white/90
                            backdrop-blur-sm border border-emerald-100
              ...
              <div className="flex items-center gap-2 min-w-0">
                ...
                <p className="text-xs font-semibold text-gray-600 truncate">
                  Prefer chatting? Talk to our safari experts
                </p>
              </div>
              <a
                href={`https://wa.me/${WA}`}
                ...
                className="flex-shrink-0 bg-[#25D366] hover:bg-[#1ebe5d]
                           text-white font-bold text-xs px-3 py-1.5
          ...
          {/* ── Slim progress bar ── */}
          <div className="w-full max-w-2xl xl:max-w-3xl 2xl:max-w-4xl mb-3 lg:mb-4">
            <div className="flex items-center gap-2.5">
              <div className="flex-1 h-1.5 lg:h-2 bg-white/60 rounded-full overflow-hidden
          ...
          {/* ══════════════════════════════════════
             FORM CARD — full width, grows with screen
          ══════════════════════════════════════ */}
          <motion.div
          ...
          >
            ...
            {/* Form content area */}
            <div className="flex-1 px-5 sm:px-7 lg:px-10 xl:px-12
          ...
          {/* ── Trust badges ── */}
          <div className="flex flex-wrap justify-center gap-2 mt-4 lg:mt-6 mb-4">
            {[
