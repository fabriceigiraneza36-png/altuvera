...
const css = `
  ...
  .bk-email-verify {
    ...
    animation:bk-slide-down 0.3s cubic-bezier(0.16,1,0.3,1);
  }
  .bk-email-verify__inner {
    padding:16px 18px;
  }
  .bk-email-verify__header {
    display:flex;align-items:center;gap:10px;margin-bottom:10px;
  }
  .bk-email-verify__icon {
  ...
  .bk-email-verify__title {
    font-size:14px;font-weight:800;color:#065f46;margin:0 0 2px;
  }
  .bk-email-verify__sub {
    font-size:12.5px;color:#6b7280;margin:0;line-height:1.5;
  }
  .bk-email-verify__email-chip {
    display:inline-flex;align-items:center;gap:6px;
    padding:5px 12px;border-radius:999px;
    background:rgba(5,150,105,0.1);border:1px solid #a7f3d0;
    font-size:12.5px;font-weight:700;color:#065f46;
    margin-bottom:14px;max-width:100%;overflow:hidden;
  }
  .bk-email-verify__email-chip span {
    overflow:hidden;text-overflow:ellipsis;white-space:nowrap;
  }
  .bk-email-verify__sent-msg {
  ...
  .bk-email-verify__sent-icon {
    font-size:20px;flex-shrink:0;margin-top:1px;
  }
  .bk-email-verify__actions {
    display:flex;align-items:center;justify-content:space-between;
    gap:10px;flex-wrap:wrap;
  }
  .bk-email-verify__resend-btn {
    display:inline-flex;align-items:center;gap:6px;
  ...
  .bk-email-verify__resend-btn:hover:not(:disabled) {
    transform:translateY(-1px) scale(1.02);
    box-shadow:0 5px 16px rgba(16,185,129,0.32);
  }
  .bk-email-verify__resend-btn:disabled {
    opacity:0.55;cursor:not-allowed;transform:none;
  }
  .bk-email-verify__cooldown {
    font-size:12px;font-weight:600;color:#9ca3af;
    display:flex;align-items:center;gap:5px;
  }
  .bk-email-verify__cooldown-ring {
    width:20px;height:20px;flex-shrink:0;
  }
  .bk-email-verify__wa-link {
    display:inline-flex;align-items:center;gap:6px;
  ...
  .bk-email-verify__wa-link:hover { background:rgba(37,211,102,0.15); }

  /* Verified state */
  .bk-email-verify--success {
    border-color:#059669;
    background:linear-gradient(135deg,#ecfdf5,#d1fae5);
    animation:bk-pop 0.45s cubic-bezier(0.34,1.56,0.64,1);
  }
  .bk-email-verify__success-content {
    display:flex;align-items:center;gap:14px;padding:16px 18px;
  }
  .bk-email-verify__success-icon {
    width:44px;height:44px;border-radius:50%;flex-shrink:0;
    background:linear-gradient(135deg,#059669,#10b981);
    display:flex;align-items:center;justify-content:center;
    color:#fff;
    box-shadow:0 4px 14px rgba(5,150,105,0.3);
    animation:bk-verify-success 0.5s cubic-bezier(0.34,1.56,0.64,1);
  }
  .bk-email-verify__success-title {
    font-size:14.5px;font-weight:800;color:#065f46;margin:0 0 3px;
  }
  .bk-email-verify__success-sub {
    font-size:12.5px;color:#6b7280;margin:0;
  }

  /* Pending dot animation */
  .bk-email-verify__pending-dot {
  ...
  .bk-email-verify__pending-dot::after {
    content:'';position:absolute;inset:0;
    border-radius:50%;background:#f59e0b;
    animation:bk-pulse-ring 1.4s ease-out infinite;
  }
  ...
  .bk-opt-card--active .bk-opt-card__label { color:#065f46; }
  ...
  .bk-check-row:hover {
    border-color:#a7f3d0;background:#fafffe;
  }
  .bk-check {
  ...
  .bk-summary__row:hover { background:rgba(255,255,255,0.4); }
  .bk-summary__key {
    font-size:13px;font-weight:600;color:#6b7280;
    white-space:nowrap;min-width:120px;
  }
  .bk-summary__val {
    font-size:13.5px;font-weight:700;color:#064e3b;
  ...
  .bk-success-verify-box {
    background:linear-gradient(135deg,#eff6ff,#dbeafe);
    border:1.5px solid #bfdbfe;border-radius:16px;
    padding:18px 22px;margin:0 auto 24px;
    max-width:480px;display:flex;gap:14px;align-items:flex-start;
    text-align:left;
  }
  ...
  .bk-verify-card {
    ...
    animation:bk-scale-in 0.4s cubic-bezier(0.16,1,0.3,1);
  }
  .bk-verify-icon {
  ...
  @media (max-width:640px) {
    ...
    .bk-summary     { padding:0; }
    .bk-summary__row { padding:12px 16px; }
    .bk-summary__key { min-width:unset; }
    .bk-verify-card { padding:32px 20px; }
    .bk-email-verify__actions { flex-direction:column;align-items:flex-start; }
    .bk-success-verify-box { flex-direction:column;gap:10px; }
  }
  ...
  .bk-select-modal__search-wrap {
    position:relative;padding:12px 18px 6px;flex-shrink:0;
  }
  ...
  .bk-select-modal__rating { font-size:12px;font-weight:700;color:#f59e0b; }
  .bk-select-modal__check  { font-size:14px;font-weight:800;color:#059669; }
