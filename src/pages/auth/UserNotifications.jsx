...
export default function UserNotifications() {
  ...
  return (
    <>
      <Helmet>
        <title>Notifications | Altuvera</title>
      </Helmet>
            ...
            >
              <div style={{
                ...
                <button
                  ...
                  style={{
                    fontSize: 12, color: '#92400e', background: 'transparent',
                  ...
                  <div>
                    ...
                    {alert.travelDate && (
                      <p style={{ margin: '4px 0 0', fontSize: 12, color: '#94a3b8' }}>
                        Departure: {new Date(alert.travelDate).toLocaleDateString('en-US', {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <p style={{ margin: 0, fontSize: 14, color: '#64748b' }}>
                ...
                {unreadCount > 0 && (
                  <span style={{
                    marginLeft: 8, background: '#059669', color: '#fff',
            ...
            >
              ...
              {t.count > 0 && (
                <span style={{
                  ...
                  background: tab === t.key ? '#ecfdf5' : '#e2e8f0',
                  color: tab === t.key ? '#059669' : '#64748b',
                        ...
                        {n.reply_text && (
                          <div style={{
                            ...
                            <p style={{ margin: 0, fontSize: 12, color: '#64748b' }}>
                              Your reply: {n.reply_text}
                              {!n.admin_reply && (
                                <span style={{ marginLeft: 8, color: '#94a3b8', fontStyle: 'italic' }}>
                                  (awaiting response)
                                </span>
                              )}
                            </p>
                              ...
                              <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                                <button
                                  ...
                                  style={{
                                    ...
                                    cursor: replyTexts[n.id]?.trim() ? 'pointer' : 'not-allowed',
                                    opacity: replyTexts[n.id]?.trim() ? 1 : 0.5,
                                  }}
                                >
                                  Send Reply
                                </button>
              ...
              <div style={{ textAlign: 'center', padding: '16px 24px', borderTop: '1px solid #f1f5f9' }}>
                <button
                  ...
                  style={{
                    ...
                    color: '#059669', fontWeight: 700, fontSize: 14, cursor: 'pointer',
                  }}
                >
...
const btnStyle = (color) => ({
  ...
  background: `${color}0a`, color: color,
