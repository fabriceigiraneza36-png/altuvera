...
export const BRAND_LOGO_ALT = "Altuvera Safaris - Premium African Safari Experiences";
export const BRAND_DESCRIPTION = "Experience the magic of Africa with Altuvera Safaris. We offer premium safari experiences across Kenya, Tanzania, Uganda, Rwanda, and beyond.";
...
export const getRedirectUrl = (pathname) => {
  ...
  const knownRoutes = [
    '/', '/destinations', '/explore', '/services', '/about', '/contact',
    '/booking', '/gallery', '/tips', '/posts', '/interactive-map',
    '/virtual-tour', '/team', '/faq', '/privacy', '/terms', '/payment-terms',
    '/profile', '/my-bookings', '/wishlist', '/settings',
    '/country/kenya', '/country/tanzania', '/country/uganda', '/country/rwanda',
  ];
...
export const getAllCountryRoutes = () => [
  '/country/kenya', '/country/tanzania', '/country/uganda', '/country/rwanda',
  '/country/ethiopia', '/country/djibouti', '/country/botswana',
  '/country/namibia', '/country/south-africa', '/country/zambia', '/country/zimbabwe',
];
...
export const generateBreadcrumbs = (pathname) => {
  ...
  const labelMap = {
    'country': 'Countries', 'destination': 'Destinations', 'destinations': 'Destinations',
    'post': 'Blog', 'posts': 'Blog', 'tips': 'Travel Tips', 'services': 'Services',
    'about': 'About Us', 'contact': 'Contact', 'booking': 'Book Now',
    'gallery': 'Gallery', 'team': 'Our Team', 'faq': 'FAQ',
    'privacy': 'Privacy Policy', 'terms': 'Terms of Service',
    'payment-terms': 'Payment Terms', 'interactive-map': 'Interactive Map',
    'virtual-tour': 'Virtual Tour', 'explore': 'Explore',
    'profile': 'My Profile', 'my-bookings': 'My Bookings',
