// AuthModal.jsx - Premium Redesign with Stunning Animations
import React, {
  useEffect,
  useMemo,
  useRef,
...
const SIDE_MEDIA = [
  {
    type: "image",
    src: "https://images.unsplash.com/photo-1516426122078-7f2c6f6a0e3d?auto=format&fit=crop&w=1200&q=85",
    alt: "Majestic male lion resting in golden savanna grass",
    caption: "Serengeti, Tanzania",
    accent: "#c67f32",
  },
  {
    type: "image",
    src: "https://images.unsplash.com/photo-1506929562872-bb421503efbf?auto=format&fit=crop&w=1200&q=85",
    alt: "Crystal turquoise waters and white sand beach",
  ...
  },
  {
    ...
    alt: "Snow-capped Mount Kilimanjaro rising above clouds",
  ...
  },
  {
    ...
    alt: "Mountain gorilla in misty Volcanoes National Park forest",
  ...
  },
  {
    ...
    alt: "Graceful giraffes at sunset in the savanna",
  ...
  },
  {
    ...
    alt: "Proud Maasai warrior in traditional attire",
  ...
  },
  {
    ...
    alt: "Luxury safari camp at golden hour",
  ...
  },
  {
    ...
    alt: "Vast East African savanna at sunset",
