...
const SocialButtons = ({
  mode,
  googleLoaded, googleLoading, githubLoading, loading,
  onGoogle, onGithub,
}) => (
  <div className="grid grid-cols-2 gap-3">
    ...
    >
      ...
      <span>{!googleLoaded ? "Loading…" : googleLoading ? "Connecting…" : "Google"}</span>
    </button>
    <button
      type="button"
...
export default function AuthModal() {
  ...
  }, [emailOk, nameOk, form.email, form.fullName, form.keepSignedIn, login, setSessionPreference, startExpiryCountdown]);
